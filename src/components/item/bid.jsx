...
const Bid = ({ setBidOpen }) => {
    ...
    useEffect(() => {
        document.querySelectorAll(".checkout__input")[1].value = '1';
    });
        ...
        <div className='checkout__wrapper'>
            <div className="chackout">
                <div className="checkout__info">
                    ...
                    <div className="checkout__input--wrapper bid__wrapper">
                        <p>Your bid (ETH)</p>
                        <input type="text" className='checkout__input' placeholder='Enter bid'/>
                    </div>
